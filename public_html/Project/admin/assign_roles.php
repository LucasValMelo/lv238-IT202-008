                ...
                <tr>
                    <td>
                        <table class="table">
                            <?php foreach ($users as $user) : ?>
                                <tr>
                                    <td>
                                        <?php render_input(["type" => "checkbox", "id" =>"user_".se($user,'id'), "name" => "users[]", "label" => se($user, "username"), "value" => se($user, 'id')])?>
                    ...
                    <td>
                        <?php foreach ($active_roles as $role) : ?>
                            <div>
                            <?php render_input(["type" => "checkbox", "id" =>"role_".se($role,'id'), "name" => "roles[]", "label" => se($role, "name"), "value" => se($role, 'id')])?>
