...
$edit = "";
$delete = "";
$bookmark = get_url("bookmark.php");
$view = get_url("anime.php");
if (has_role("Admin")) {
    $edit = get_url("admin/edit_anime.php");
    $delete = get_url("admin/delete_entry.php");
}

$table = ["data" => $results, "title" => "Latest Anime Ranking", "edit_url" => $edit, "delete_url" => $delete, "view_url" => $view, "bookmark_url" => $bookmark];
?>
